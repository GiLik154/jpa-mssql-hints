...
class NoLockStatementInspectorGlobTest {
    ...
    class 화이트_glob {
        ...
        void prefix(String table) {
            NoLockStatementInspector inspector = new NoLockStatementInspector(
                    Mode.ANNOTATION, List.of(), List.of("stat_*")
            );
        ...
        void suffix(String table) {
            NoLockStatementInspector inspector = new NoLockStatementInspector(
                    Mode.ANNOTATION, List.of(), List.of("*_log")
            );
        ...
        void 중간() {
            NoLockStatementInspector inspector = new NoLockStatementInspector(
                    Mode.ANNOTATION, List.of(), List.of("*audit*")
            );
    ...
    class 블랙_glob {
        ...
        void prefix_차단(String table) {
            NoLockStatementInspector inspector = new NoLockStatementInspector(
                    Mode.GLOBAL, List.of("payment_*"), List.of()
            );
    ...
    class 정확_매칭_회귀 {
        ...
        void 정확_매칭_그대로() {
            NoLockStatementInspector inspector = new NoLockStatementInspector(
                    Mode.GLOBAL, List.of("payment"), List.of()
            );
